...
import highIndexLens from "../img/contact-lens/types/high-index-lens.png";
import progressiveLens from "../img/contact-lens/types/progressive-lens.jpg";
import bifocalLens from "../img/contact-lens/types/bifocal-lens.jpg";
